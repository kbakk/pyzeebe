...
from pyzeebe.grpc_internals.grpc_client_config import _grpc_channel_options
...
class ZeebeAdapterBase(object):
    ...
    def _create_channel(connection_uri: str, credentials: BaseCredentials = None,
        ...
        if credentials:
            return grpc.secure_channel(connection_uri, credentials.grpc_credentials, options=_grpc_channel_options())
        elif secure_connection:
            return grpc.secure_channel(connection_uri, grpc.ssl_channel_credentials(), options=_grpc_channel_options())
        else:
            return grpc.insecure_channel(connection_uri, options=_grpc_channel_options())
